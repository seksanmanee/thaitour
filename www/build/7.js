...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chat_box__ = __webpack_require__(909);
...
var ChatBoxPageModule = (function () {
    function ChatBoxPageModule() {
    }
    return ChatBoxPageModule;
}());
ChatBoxPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__chat_box__["a" /* ChatBoxPage */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__pipes_main_pipe_module__["a" /* MainPipeModule */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__chat_box__["a" /* ChatBoxPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__chat_box__["a" /* ChatBoxPage */]
        ]
...
var ChatBoxPage = (function () {
    function ChatBoxPage(navParams, viewCtrl, chatProvider, modalCtrl, afDb, storageProvider) {
    ...
    ChatBoxPage.prototype.ngOnInit = function () {
        var _this = this;
        this.getReceiverInformation().then(function () {
            _this.loadStorageData().then(function () {
                _this.getChetMessages();
            });
        });
    };
    /**
     ...
     * --------------------------------------------------------------
     */
    ChatBoxPage.prototype.getReceiverInformation = function () {
     ...
     */
    ChatBoxPage.prototype.loadStorageData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storageProvider.get().then(function (success) {
                            _this.currentUserInfo = success;
                        })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
     ...
     */
    ChatBoxPage.prototype.getChetMessages = function () {
        var _this = this;
        this.chatProvider.getChatRef(this.currentUserInfo.userId, this.receiverInfo.uid)
            .then(function (chatRef) {
            _this.chatRef = _this.afDb.list("/chats/" + chatRef);
            _this.chatMessages = _this.chatRef.valueChanges();
            _this.chatMessages.subscribe();
     ...
     * --------------------------------------------------------------
     */
    ChatBoxPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
     ...
     */
    ChatBoxPage.prototype.readAllMessages = function () {
     ...
     * @param userId
     */
    ChatBoxPage.prototype.gotoUserProfile = function (userId) {
     ...
     * --------------------------------------------------------------
     */
    ChatBoxPage.prototype.onFocus = function () {
        this.content.resize();
        this.scrollToBottom();
    };
    /**
     ...
     */
    ChatBoxPage.prototype.dismiss = function () {
