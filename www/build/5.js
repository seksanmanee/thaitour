...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__single_post__ = __webpack_require__(928);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pipes_main_pipe_module__ = __webpack_require__(890);
...
var SinglePostPageModule = (function () {
    function SinglePostPageModule() {
    }
    return SinglePostPageModule;
}());
SinglePostPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__single_post__["a" /* SinglePostPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__pipes_main_pipe_module__["a" /* MainPipeModule */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__single_post__["a" /* SinglePostPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__single_post__["a" /* SinglePostPage */]
        ]
...
//# sourceMappingURL=single-post.module.js.map
...
;(function (global, factory) {
    true ? factory(__webpack_require__(765)) :
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MainPipeModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pipes_timeago_timeago_pipe__ = __webpack_require__(891);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pipes_date_filter_date_filter__ = __webpack_require__(893);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
MainPipeModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [__WEBPACK_IMPORTED_MODULE_2__pipes_timeago_timeago_pipe__["a" /* TimeAgoPipe */], __WEBPACK_IMPORTED_MODULE_3__pipes_date_filter_date_filter__["a" /* DateFilterPipe */]],
        imports: [__WEBPACK_IMPORTED_MODULE_1__angular_common__["b" /* CommonModule */]],
        exports: [__WEBPACK_IMPORTED_MODULE_2__pipes_timeago_timeago_pipe__["a" /* TimeAgoPipe */], __WEBPACK_IMPORTED_MODULE_3__pipes_date_filter_date_filter__["a" /* DateFilterPipe */]]
    })
], MainPipeModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_moment__ = __webpack_require__(765);
...
var momentConstructor = __WEBPACK_IMPORTED_MODULE_1_moment__["default"] || __WEBPACK_IMPORTED_MODULE_1_moment__;
var TimeAgoPipe = (function () {
    ...
    TimeAgoPipe.prototype.getTime = function (value) {
        if (__WEBPACK_IMPORTED_MODULE_1_moment__["isDate"](value)) {
            return value.getTime();
        }
        else if (__WEBPACK_IMPORTED_MODULE_1_moment__["isMoment"](value)) {
...
TimeAgoPipe = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["W" /* Pipe */])({ name: 'timeAgo', pure: false }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["k" /* ChangeDetectorRef */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["P" /* NgZone */]])
], TimeAgoPipe);
...
var DateFilterPipe = (function () {
    ...
    DateFilterPipe.prototype.transform = function (array, args) {
        if (array === void 0) { array = []; }
        if (typeof args[0] === "undefined") {
            return array;
        }
        var direction = args[0][0];
        var string1 = args.split('-');
        if (string1[1].indexOf('.') !== -1) {
            // would be true. Period found in file name
            var string2_1 = string1[1].split('.');
            array.sort(function (a, b) {
                var left = Number(new Date(a[string2_1[0]][string2_1[1]]));
                var right = Number(new Date(b[string2_1[0]][string2_1[1]]));
                return (direction === "-") ? right - left : left - right;
            });
        }
        else {
            array.sort(function (a, b) {
                var left = Number(new Date(a[string1[1]]));
                var right = Number(new Date(b[string1[1]]));
                return (direction === "-") ? right - left : left - right;
            });
        }
        return array;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_post_post__ = __webpack_require__(165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_utils_utils__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__ = __webpack_require__(381);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_utils_storage__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_admob_free_admob_free__ = __webpack_require__(169);
/**
 * @author    Ionic Bucket <ionicbucket@gmail.com>
 * @copyright Copyright (c) 2017
 * @license   Fulcrumy
...
var SinglePostPage = (function () {
    function SinglePostPage(navParams, viewCtrl, postProvider, platform, socialSharing, modalCtrl, storageProvider, utilsProvider, admobFree) {
    ...
    SinglePostPage.prototype.ionViewDidLoad = function () {
        ...
        this.getNavParamsData().then(function () {
            _this.loadStorageData().then(function () {
                _this.getPostByPostId();
            });
        });
     ...
     */
    SinglePostPage.prototype.loadStorageData = function () {
     ...
     */
    SinglePostPage.prototype.getNavParamsData = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    SinglePostPage.prototype.getPostByPostId = function () {
        var _this = this;
        try {
            this.postProvider.getPostById(this.userId, this.postkey).then(function (success) {
                _this.postInfo = success;
            });
        }
        catch (err) {
            console.log(err);
     ...
     */
    SinglePostPage.prototype.likePost = function (postkey, postOwner) {
        var _this = this;
        try {
            this.postProvider.likePost(postkey, postOwner, this.userId)
                .subscribe(function () {
                _this.postInfo.isLike = true;
            }, function (error) {
                console.log(error);
            });
        }
     ...
     * @param postkey     Post unique ID/Key
     */
    SinglePostPage.prototype.unlikePost = function (postkey) {
        var _this = this;
        try {
            this.postProvider.unlikePost(postkey, this.userId)
                .subscribe(function () {
                _this.postInfo.isLike = false;
            }, function (error) {
                console.log(error);
            });
        }
     ...
     */
    SinglePostPage.prototype.gotoCommentPage = function () {
     ...
     */
    SinglePostPage.prototype.shareOptions = function () {
        var _this = this;
        var buttons = [
            { text: 'Facebook' },
            { text: 'Twitter' },
        ...
        this.platform.ready()
            ...
            _this.utilsProvider.presentActionSheet(buttons).then(function (result) {
     ...
     */
    SinglePostPage.prototype.shareViaFacebook = function () {
        var _this = this;
        this.socialSharing.shareViaFacebook(this.postInfo.text, this.postInfo.featureImage, null)
            .then(function (data) {
            _this.utilsProvider.presentToast('Your post is open to share on Facebook', 3000, 'top');
        })
            .catch(function (err) {
            _this.utilsProvider.presentToast('Failed to share your post', 3000, 'top');
        });
    };
    /**
     * --------------------------------------------------------------
     ...
     */
    SinglePostPage.prototype.shareViaTwitter = function () {
        var _this = this;
        this.socialSharing.shareViaTwitter(this.postInfo.text, this.postInfo.featureImage, null)
            .then(function (data) {
            _this.utilsProvider.presentToast('Your post is open to share on Twitter', 3000, 'top');
        })
            .catch(function (err) {
            _this.utilsProvider.presentToast('Failed to share your post', 3000, 'top');
        });
     ...
     */
    SinglePostPage.prototype.shareViaWhatsApp = function () {
        var _this = this;
        this.socialSharing.shareViaWhatsApp(this.postInfo.text, this.postInfo.featureImage, null)
            .then(function (data) {
            _this.utilsProvider.presentToast('Your post is open to share on WhatsApp', 3000, 'top');
        })
            .catch(function (err) {
            _this.utilsProvider.presentToast('Failed to share your post', 3000, 'top');
        });
     ...
     * --------------------------------------------------------------
     */
    SinglePostPage.prototype.prepareBanner = function () {
     ...
     * --------------------------------------------------------------
     */
    SinglePostPage.prototype.prepareInterstitial = function () {
     ...
     * --------------------------------------------------------------
     */
    SinglePostPage.prototype.removeBanner = function () {
     ...
     */
    SinglePostPage.prototype.dismiss = function () {
        this.removeBanner();
...
SinglePostPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */],
        ...
        __WEBPACK_IMPORTED_MODULE_6__providers_admob_free_admob_free__["a" /* AdmobFreeProvider */]])
], SinglePostPage);
