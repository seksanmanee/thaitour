...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__followers__ = __webpack_require__(911);
...
FollowersPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__followers__["a" /* FollowersPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__followers__["a" /* FollowersPage */]
        ]
...
var FollowersPage = (function () {
    function FollowersPage(navParams, viewCtrl, connectionsProvider, utilsProvider, sharedProvider, modalCtrl) {
        ...
        this.followersList = []; // Array of followers list
        this.newFollowersList = []; // Array of new followers list
    }
    /***
     * --------------------------------------------------------------
     ...
     * --------------------------------------------------------------
     */
    FollowersPage.prototype.getNavParamsData = function () {
     ...
     * user's.
     */
    FollowersPage.prototype.getFollowersUser = function () {
        var _this = this;
        this.utilsProvider.presentLoading();
        this.connectionsProvider.getFollowersUser(this.userId).then(function (data) {
            _this.followersList = data;
            _this.newFollowersList = _this.followersList;
     ...
     *
     */
    FollowersPage.prototype.unFollow = function (user) {
        var _this = this;
     ...
     */
    FollowersPage.prototype.follow = function (user) {
     ...
     * @param ev
     */
    FollowersPage.prototype.getSearchResult = function (ev) {
     ...
     * @param userId
     */
    FollowersPage.prototype.gotoUserProfile = function (userId) {
        var _this = this;
...
FollowersPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-followers',template:/*ion-inline-start:"C:\MobileApp\ionicbucket-socialapp\src\pages\followers\followers.html"*/'<!-- \n  - @author    Ionic Bucket <ionicbucket@gmail.com>\n  - @copyright Copyright (c) 2017\n  - @license   Fulcrumy\n-->\n<!-- Followers Page -->\n\n<ion-header no-border>\n  <ion-navbar color="white">\n    <ion-buttons start>\n      <button ion-button color="default" clear (click)="dismiss()">\n        <ion-icon name="close" style="zoom:2.0;"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>Followers</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n  <!--\n    -  ** Search Option **\n    -  The below search box will help to find out the particular user from the follower user\'s list\n  -->\n  <ion-searchbar animated="true" autocomplete="on" (ionInput)="getSearchResult($event)"></ion-searchbar>\n\n  <br>\n\n  <ion-list>\n    <ion-item *ngFor="let user of followersList; let i = index">\n\n      <!-- User profile picture -->\n      <ion-avatar item-start (click)="gotoUserProfile(user.uid)">\n        <img [src]="user.image">\n      </ion-avatar>\n\n      <!-- User Name -->\n      <h2 (click)="gotoUserProfile(user.uid)">{{ user.name }}</h2>\n\n      <!-- Unfollow button -->\n      <button ion-button color="dark" item-right outline *ngIf="user.isFollowing" (click)="unFollow(user)">\n        Following\n      </button>\n\n      <!-- Follow user -->\n      <button ion-button color="default" item-right outline *ngIf="!user.isFollowing" (click)="follow(user)">\n        Follow\n      </button>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"C:\MobileApp\ionicbucket-socialapp\src\pages\followers\followers.html"*/,
    }),
