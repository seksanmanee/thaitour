...
}(this, (function (exports,rxjs,rxjs_operators,_angular_core,angularfire2,_firebase_storage) { 'use strict';
...
function createStorageRef(ref, scheduler) {
    return {
        getDownloadURL: function () {
            return scheduler.keepUnstableUntilFirst(scheduler.runOutsideAngular(rxjs.from(ref.getDownloadURL())));
        },
        getMetadata: function () {
            return scheduler.keepUnstableUntilFirst(scheduler.runOutsideAngular(rxjs.from(ref.getMetadata())));
        },
